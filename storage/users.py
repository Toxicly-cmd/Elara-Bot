...
_store = CollectionStore(
    name=CollectionName,
    defaults={'balance': 0, 'level': 0, 'xp': 0, 'transfered_balance': 0, 'received_balance': 0, 'economy_rules_accepted': False, 'type': 'user', 'relationship': 'single', 'no_prefix': False, 'no_prefix_subscription': False, 'extra_owner': False, 'staff': False, 'badges': [], 'bio': None, 'custom_avatar': None, 'custom_banner': None, 'banned': False, 'updated_at': NOW, 'created_at': NOW},
    unique_sets=[['user_id']],
    json_fields=set(['badges']),
